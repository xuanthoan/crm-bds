...
export function LeadAssignModal({ lead, owners, onClose, onSubmit }: { lead: Lead; owners: AdminUser[]; onClose: () => void; onSubmit: (ownerId: string, note: string) => Promise<void> }) {
