...
export const ACTIVITY_LABELS: Record<LeadActivityType, string> = { note: 'Ghi chú', call: 'Cuộc gọi', zalo: 'Zalo', meeting: 'Cuộc hẹn', status_change: 'Đổi trạng thái', assignment: 'Phân công' };
