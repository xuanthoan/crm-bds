...
export type LeadFilters = { page?: number; page_size?: number; search?: string; status?: string; priority?: string; source?: string; scope?: string; care_due?: string; care_status?: string; next_follow_up?: string; activity_status?: string; has_activity?: boolean | string; stale?: boolean | string; owner_id?: string; department_id?: string; team_id?: string; created_from?: string; created_to?: string; start_date?: string; end_date?: string };
