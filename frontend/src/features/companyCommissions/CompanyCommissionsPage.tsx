...
import { CommissionGlossaryHelpButton } from '../commissions/CommissionGlossaryHelp';
  ...
  return (
    <section className="page company-commissions-page">
      <header className="page-header">
        <div><div className="page-title-with-help"><h1>Hoa hồng công ty</h1><CommissionGlossaryHelpButton /></div><p>Theo dõi hoa hồng công ty phải thu từ chủ đầu tư, chủ đất, chủ nhà hoặc đối tác.</p></div>
