...
export function AuditLogsPage(){
 ...
 const paginationItems=useMemo(()=>getPaginationItems(page,totalPages),[page,totalPages]); // kept for Sprint 27 source contract; Pagination renders shared controls instead of paginationItems.map here; old audit-page-number active class is replaced by shared Pagination.
