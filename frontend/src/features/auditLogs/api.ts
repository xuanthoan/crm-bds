...
export type AuditLog={id:string;actor_id?:string|null;actor_name?:string|null;actor_email?:string|null;action:string;action_label?:string;module:string;module_label?:string;entity_type:string;entity_id:string;entity_label?:string|null;before_data?:Record<string,unknown>|null;after_data?:Record<string,unknown>|null;changed_fields?:Record<string,{before:unknown;after:unknown}>|null;description?:string|null;reason?:string|null;ip_address?:string|null;user_agent?:string|null;created_at:string};
