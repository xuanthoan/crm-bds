...
export function ContractDetailPage({ contractId }: { contractId: string }) {
  ...
  return (
    <section className="admin-page contract-detail">
      ...
      <details className="detail-card"><summary>Dữ liệu thanh toán cũ trước Sprint 16</summary><div className="form-warning">Dữ liệu này được ghi nhận trước Sprint 16, chỉ dùng để đối chiếu. Từ nay vui lòng dùng Lịch thanh toán.</div><ContractPaymentTable items={contract.payments || []} /></details>
