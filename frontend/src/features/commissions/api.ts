...
export const cancelCommission=(id:string,p:Record<string,unknown>)=>apiRequest<Commission>(`/api/v1/commissions/${id}/cancel`,{method:'POST',body:JSON.stringify(p)});
export const markPaidCommission=(id:string,p:Record<string,unknown>)=>apiRequest<Commission>(`/api/v1/commissions/${id}/mark-paid`,{method:'POST',body:JSON.stringify(p)});
