  ...
  return (
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <nav>
          <div className="nav-section"><span>Dashboard</span>{can('dashboard.view.own') || can('dashboard.view.team') || can('dashboard.view.all') ? <div>{renderLink('Tổng quan của tôi', '/dashboard/my-work')}</div> : null}{can('dashboard.sale.view') || can('dashboard.view.own') || can('dashboard.view.all') ? <div>{renderLink('Dashboard của tôi', '/dashboard/sale')}</div> : null}{can('dashboard.view.team') || can('dashboard.view.all') ? <div>{renderLink('Tổng quan team', '/dashboard/team-work')}</div> : null}{can('dashboard.boss.view') || can('dashboard.view.all') || can('reports.view.ceo_dashboard') ? <div>{renderLink('Tổng quan giám đốc', '/dashboard/boss')}</div> : null}{can('dashboard.sales_manager.view') || can('dashboard.leader.view') || can('dashboard.team.view') || can('dashboard.sales.view.all') || can('dashboard.view.all') ? <div>{renderLink('Tổng quan quản lý sale', '/dashboard/sales-management')}</div> : null}</div>
