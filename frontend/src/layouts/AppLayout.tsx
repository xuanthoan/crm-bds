    ...
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <nav>
          ...
          {(canViewLeads || canViewCustomers || canViewDeals || canViewBookings || canViewContracts || canViewPayments || canViewFinanceReports || canViewCommissionReports || can('tasks.view') || can('tasks.view_all')) && (
