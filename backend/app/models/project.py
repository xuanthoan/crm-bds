...
class Project(Base):
    ...
    sales_commission_payout_policy_default: Mapped[str | None] = mapped_column(String(50))
    sales_commission_policy_note: Mapped[str | None] = mapped_column(Text)
    company_commission_policy_note: Mapped[str | None] = mapped_column(Text)
