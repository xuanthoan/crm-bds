...
def _optional_positive_amount(value: Decimal | None, message: str) -> Decimal | None:
...
def _positive_booking_amount(value: Decimal | None) -> Decimal | None:
    return _optional_positive_amount(value, "Tiền giữ chỗ phải lớn hơn 0")


def _positive_deposit_amount(value: Decimal | None) -> Decimal | None:
    return _optional_positive_amount(value, "Tiền cọc phải lớn hơn 0")
