...
def all(page:int=Query(1,ge=1),page_size:int=Query(20,ge=1,le=100),q:str|None=None,status_filter:str|None=Query(None,alias='status'),contract_id:UUID|None=None,deal_id:UUID|None=None,customer_id:UUID|None=None,overdue:bool|None=None,due:bool|None=None,outstanding:bool|None=None,as_of:date|None=None,date_from:date|None=None,date_to:date|None=None,db:Session=Depends(get_db),actor:User=Depends(require_auth)):
    items,meta=list_schedules(db,actor,page,page_size,q,status_filter,contract_id,deal_id,customer_id,overdue,due,outstanding,as_of,date_from,date_to); return success_response([serialize_schedule(i) for i in items],meta=meta)
