...
PERMISSION_CODES_BY_MODULE = {'activities': ['activities.view.own',
 ...
 'dashboard': ['dashboard.view.own', 'dashboard.view.team', 'dashboard.view.all', 'dashboard.sale.view', 'dashboard.boss.view', 'dashboard.sales_manager.view', 'dashboard.leader.view', 'dashboard.team.view', 'dashboard.sales.view.all'],
