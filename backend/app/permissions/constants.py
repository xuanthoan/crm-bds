...
PERMISSION_CODES_BY_MODULE = {
    ...
    "lead_tasks": ["lead_tasks.view.own", "lead_tasks.view.team", "lead_tasks.view.all", "lead_tasks.create", "lead_tasks.update.own", "lead_tasks.update.team", "lead_tasks.update.all", "lead_tasks.delete", "lead_tasks.complete.own", "lead_tasks.complete.team", "lead_tasks.complete.all"],
    "lead_appointments": ["lead_appointments.view.own", "lead_appointments.view.team", "lead_appointments.view.all", "lead_appointments.create", "lead_appointments.update.own", "lead_appointments.update.team", "lead_appointments.update.all", "lead_appointments.delete", "lead_appointments.complete.own", "lead_appointments.complete.team", "lead_appointments.complete.all"],
...
ROLE_PERMISSION_MAP = {
    ...
    "director": ["lead_tasks.view.all", "lead_tasks.update.all", "lead_tasks.complete.all", "lead_appointments.view.all", "lead_appointments.update.all", "lead_appointments.complete.all", "dashboard.view.all", "customers.view.all", "leads.view.all", "inventory.view.all", "deals.view.all", "activities.view.all", "marketing.view", "marketing.view_roi", "payments.view", "commissions.view.all", "reports.view.all", "reports.view.ceo_dashboard", "reports.view.marketing_roi", "reports.view.finance", "reports.export", "audit_logs.view"],
    "sales_manager": ["lead_tasks.view.team", "lead_tasks.create", "lead_tasks.update.team", "lead_tasks.complete.team", "lead_appointments.view.team", "lead_appointments.create", "lead_appointments.update.team", "lead_appointments.complete.team", "dashboard.view.team", "customers.view.department", "customers.create", "customers.update.all", "customers.transfer_owner", "leads.view.department", "leads.create", "leads.update.all", "leads.assign.all", "leads.reclaim.all", "inventory.view.all", "deals.view.department", "deals.create", "deals.update.all", "deals.update_stage", "deals.approve", "activities.view.all", "activities.create", "reports.view.department", "reports.export"],
    "leader": ["lead_tasks.view.team", "lead_tasks.create", "lead_tasks.update.team", "lead_tasks.complete.team", "lead_appointments.view.team", "lead_appointments.create", "lead_appointments.update.team", "lead_appointments.complete.team", "dashboard.view.team", "customers.view.team", "customers.create", "customers.update.team", "leads.view.team", "leads.create", "leads.update.team", "leads.assign.team", "leads.reclaim.team", "inventory.view.available", "deals.view.team", "deals.create", "deals.update.team", "deals.update_stage", "activities.view.team", "activities.create", "reports.view.team"],
    "sale": ["lead_tasks.view.own", "lead_tasks.create", "lead_tasks.update.own", "lead_tasks.complete.own", "lead_appointments.view.own", "lead_appointments.create", "lead_appointments.update.own", "lead_appointments.complete.own", "dashboard.view.own", "customers.view.own", "customers.create", "customers.update.own", "leads.view.own", "leads.create", "leads.update.own", "inventory.view.available", "deals.view.own", "deals.create", "deals.update.own", "deals.update_stage", "activities.view.own", "activities.create", "reports.view.own", "commissions.view.own"],
