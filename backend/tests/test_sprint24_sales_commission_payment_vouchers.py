...
class Sprint24SalesCommissionPaymentVoucherSourceTest(unittest.TestCase):
    ...
    def test_frontend_routes_labels_and_modal_terms(self):
        ...
        for text in ['/commission-payment-vouchers','Phiếu chi hoa hồng','Nháp','Đã chi','Đã hủy','Tiền mặt','Chuyển khoản','Khác','Mã giao dịch/chứng từ','Xác nhận đã chi']:
